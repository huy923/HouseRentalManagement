                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($query)) { ?>
                                            <tr>
                                                ...
                                                <td><?php
                                                    if ($row['role'] == 1) {
                                                        echo "<span class='bg-success' style='color: white;'>Quản trị viên</span>";
                                                    }else {
                                                        echo "<span class='bg-info' style='color: white;'>Người dùng</span>";
                                                    }
                                                    ?></td>
                                                <td>
                                                    <img src="<?php echo $row['avartar']?>" alt="" style="width: 70px;">
                                                </td>
                                                <td><a href="view_profile.php?id=<?php echo $row['id'] ?>"><i class="fa fa-eye me-2"></i></a></td>
                                                <td><a href="edit_account.php?id=<?php echo $row['id'] ?>"><i class="fa fa-edit me-2"></i></a></td>
                                                <td><a href="delete_account.php?id=<?php echo $row['id'] ?>"><i class="fa fa-trash me-2"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
