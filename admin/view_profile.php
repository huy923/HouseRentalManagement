                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="owl-carousel testimonial-carousel">
                                <div class="testimonial-item text-center">
                                    <img class="img-fluid rounded-circle mx-auto mb-4" src="<?php echo $row['avartar'] ?>" style="width: 100px; height: 100px;">
                                    ...
                                    <p class="mb-0">Tài khoản đăng nhập: <?php echo $row['username'] ?></p>
                                    <p class="mb-0">Email: <?php echo $row['email'] ?></p>
                                    <p class="mb-0">Số điện thoại: <?php echo $row['phone'] ?></p>
                                </div>
                            </div>
                        </div>
                    </div>
