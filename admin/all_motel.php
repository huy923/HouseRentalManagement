        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    ...
                    $sql = 'SELECT motel.*, category.name  FROM motel JOIN category 
                    ON motel.category_id = category.id';
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($query)) { ?>
                                            <tr>
                                                ...
                                                <td><img src="<?php echo $row['images'] ?>" alt="" style="width: 70px;"></td>
                                                <td><a href="check_post.php?id=<?php echo $row['id'] ?>"><i class="fa fa-check me-2"></i></a></td>
                                                <td><a href="hide_post.php?id=<?php echo $row['id'] ?>"><i class="fa fa-eye me-2"></i></a></td>
                                                <td><a href="edit_motel.php?id=<?php echo $row['id'] ?>"><i class="fa fa-edit me-2"></i></a></td>
                                                <td><a href="delete_motel.php?id=<?php echo $row['id'] ?>"><i class="fa fa-trash me-2"></i></a></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
