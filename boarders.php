                ...
                <div class="modal-body">
                    <form action="functions/add-boarder.php" method="POST" enctype="multipart/form-data">
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-floating mb-3"><input value="<?php echo date("Y-m-d"); ?>" class="form-control form-control" placeholder="Start Date" name="start_date" type="date" required=""><label class="form-label" for="floatingInput">Start Date</label></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
